        ...
        <>
            <div className="w-full flex justify-center mt-12 sm:mt-28 mx-3">
                <form action="" className="flex flex-col">
                    ...
                    <textarea id="feedback" name="feedback" className="resize border rounded-md w-full py-2 focus:outline-none" cols="100" rows="10" placeholder="Help us out by submitting any issues, or just let us know how we're doing.">
                    </textarea>
