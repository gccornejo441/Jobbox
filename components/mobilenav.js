            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
              ...
              {/* RACKET SPACE LOG */}
                ...
                <div className="absolute inset-y-0 right-0 flex items-center lg:hidden">
                  {/* Mobile menu button*/}
                  <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-50 hover:text-regal-blue hover:bg-green-300 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
