                                        ...
                                        <ul>
                                            <li>
                                                <div class="flex flex-col text-base pl-4 pt-2">
                                                    ...
                                                    <p class="text-blue-700 text-sm">{data.school_1.start} - {data.school_1.end === null ? "Current" : data.school_1.end}</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="flex flex-col text-base pl-4 pt-2">
                                                <p class="text-blue-800 text-lg">{data.school_2.degree}</p>
                                                    ...
                                                    <p class="text-blue-700 text-sm">{data.school_2.start} - {data.school_2.end === null ? "Current" : data.school_2.end}</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="flex flex-col text-base pl-4 pt-2">
                                                <p class="text-blue-800 text-lg">{data.school_3.degree}</p>
                                                    ...
                                                    <p class="text-blue-700 text-sm">{data.school_3.start} - {data.school_3.end === null ? "Current" : data.school_3.end}</p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
