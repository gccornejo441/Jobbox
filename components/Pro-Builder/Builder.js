...
const SignupSchema = Yup.object().shape({
    ...
    internship_1: Yup.string(),
    internship_year: Yup.date()
        .when('internship_1', {
            is: (val) => typeof val == "string", // alternatively: (val) => val == true
            then: Yup.date().min(5).required('Required'),
            otherwise: Yup.date().min(0).required('Required'),
        })
})
...
const Builder = (props) => {
    ...
    const MyTextInput = ({ label, ...props }) => {
        ...
        return (
            <>
                <label className="py-3 text-md md:text-lg" htmlFor={props.id || props.name}>{label}</label>
                <input className="text-input text-md p-1 font-base text-blue-900 xl:bg-gray-100 border border-gray-200 rounded-md pl-2" {...field} {...props} />
                ...
                <div className="flex flex-col pt-16 xl:pt-8 xl:bg-white rounded-lg xl:shadow-md xl:my-12 overflow-auto h-screen xl:h-auto">
                    <div className="border-b border-gray-300 px-4 xl:px-10">
                        ...
                        >
                            {({ values, isSubmitting, }) => (
                                <Form>
                                    <span className="inline-block align-middle text-xl md:text-2xl text-regal-blue py-5">General Information</span>
                                    ...
                                    <div>
                                        <span className="inline-block align-middle text-xl md:text-2xl text-regal-blue">Education</span>
                                    ...
                                    <span className="inline-block align-middle text-xl md:text-2xl text-regal-blue">Experience</span>
                                    ...
                                    {/* SKILLS - START */}
                                    <div className="border-b border-gray-200 w-full my-5"></div>
                                    <span className="inline-block align-middle text-xl md:text-2xl text-regal-blue">Socials</span>
                                    ...
                                    <div className="border-b border-gray-200 w-full my-5"></div>
                                    <span className="inline-block align-middle text-xl md:text-2xl text-regal-blue">Internships & Volunteer Work</span>
                                    ...
                                    <div className="flex justify-center border-t border-gray-200 md:pt-16 md:pb-12">
